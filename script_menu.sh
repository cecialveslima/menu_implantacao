...
realiza_implantacao() {
	...
	if [ -z "$1" ] || [ -z "$2" ]; then
		echo "ATENCAO: ./script_implanta.sh <nome_do_container> <tomcat6 OU tomcat9>"
		exit 1
	fi
	...
	BACKUP_DIR="/home/dev-cecilia/containers/backup_container/"
	#LOCAL_CLASSES="/home/dev-cecilia/GMUD${ANO}/${DATA_ATUAL}/${CONTAINER_NAME}/" #producao
	LOCAL_CLASSES="/home/dev-cecilia/GMUD${ANO}/${CONTAINER_NAME}/"
...
while true; do
	...
	#	wget -qO- "http://10.10.10.190/webcards4/servlet/iface_login4_bes"
		;;
